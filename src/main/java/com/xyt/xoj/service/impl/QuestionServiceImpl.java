...
import com.xyt.xoj.mapper.QuestionMapper;
import com.xyt.xoj.model.dto.question.QuestionQueryRequest;
import com.xyt.xoj.model.entity.*;
import com.xyt.xoj.model.vo.QuestionAdminVo;
...
public class QuestionServiceImpl extends ServiceImpl<QuestionMapper, Question> implements QuestionService {
    ...
    public QuestionVO getQuestionVO(Question question, HttpServletRequest request) {
       ...
       /* User loginUser = userService.getLoginUserPermitNull(request);
        if (loginUser != null) {
            // 获取点赞
            QueryWrapper<QuestionSubmit> questionThumbQueryWrapper = new QueryWrapper<>();
            questionThumbQueryWrapper.in("questionId", questionId);
            questionThumbQueryWrapper.eq("userId", loginUser.getId());
            QuestionSubmit questionThumb = questionThumbMapper.selectOne(questionThumbQueryWrapper);
